...
void loadShadowShader()
{
	...
	unsigned *image = read_texture("fish_color_map.rgb", &width, &height, &components);
	...
	//glUniform1f( glGetUniformLocation(shadowShaderId, "texture_mapped"), 5.0 );
	glUniform1i( glGetUniformLocation(shadowShaderId, "texture_2D"), 0 );
}
...
void drawObjects(void)
{
    ...
    //glVertexAttribPointer( vTexCoord, 2, GL_FLOAT, GL_FALSE, 0,BUFFER_OFFSET(1000 ); 
...
void renderScene(void) 
{
	...
	glBindTexture(GL_TEXTURE_2D,floorNormalTexture);
	glUniform1i(glGetUniformLocation(shadowShaderId,"texMap",0));
	...
	//glUniform1f( glGetUniformLocation(shadowShaderId, "texture_mapped"), 0.0 );
