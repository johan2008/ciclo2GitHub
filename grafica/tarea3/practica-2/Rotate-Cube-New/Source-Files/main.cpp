...
void renderScene(void) 
{
	...
	glColorMask(GL_TRUE, GL_TRUE, GL_TRUE, GL_TRUE); //habilita los color buffer
	...
	setupMatrices(p_camera[0],p_camera[1],p_camera[2],l_camera[0],l_camera[1],l_camera[2]);//vamos a la posicion normal
	
	glCullFace(GL_BACK);//dibujamos los objetos
	drawObjects();
